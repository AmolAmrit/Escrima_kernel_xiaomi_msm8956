...
jackstuff()
{
rm -rf $kerneldir/sound/soc/codecs/wcd-mbhc-v2.h
rm -rf $kerneldir/sound/soc/codecs/wcd-mbhc-v2.c
cp -a $kerneldir/fixes/headphonejack/fix/wcd-mbhc-v2.h $kerneldir/sound/soc/codecs/
cp -a $kerneldir/fixes/headphonejack/fix/wcd-mbhc-v2.c $kerneldir/sound/soc/codecs/
}
